...
# Creating session to initialize spark and enable DataFrame operations
...
# Deserializing kafka topic bytes to JSON strings      
...
# Parsing JSON strings to Spark DataFrame
...
# Transformations
# Defining DataFrame 1 -> For Weekly Trends
...
# Defining DataFrame 2 -> Monthly Trends
